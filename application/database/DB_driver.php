...
class CI_DB_driver {
	...
	var $pconnect		= FALSE;
	var $conn_id		= FALSE;
	var $conn_type = TRUE; // ����SAE��������ݿ��� TRUE���� FALSE�ӿ�
	var $result_id		= FALSE;
	var $db_debug		= FALSE;
	var $benchmark		= 0;
	var $query_count	= 0;
...
//			}
//		}else{
//			$update_filed= explode('=', $data)[0];
//			$update_val= explode('=', $data)[1];
//			echo $update_filed.$update_val;
//			$fields[$this->_protect_identifiers($update_filed)] = 1;
//		}
