...
<head>
  ...
  <link href="<?php echo base_url("application/views/css/index.css");?>" rel="stylesheet">
</head>
</head>
<body>
...
<div class="banner">
  <section class="box">
    <ul class="texts">
      <p>本专栏内均为转载：</p>
      <p>感谢为以下文章付出辛劳和汗水的兄弟姐妹们，</p>
      <p>如果你喜欢这些文章，请注明转载，尊重别人的劳动成果</p>
    </ul>
...
<article>
  ...
  <div class="bloglist left">
    <?php foreach ($reprints as $reprint):?>
      <h3><a title="<?php echo $reprint->title;?>" href=" <?php echo "reprint/detail/".$reprint->id;?>" target="_blank" ><?php echo $reprint->title;?></a><a>[转载]</a></h3>
      <p class="dateview"><span><?php echo $reprint->insert_time ;?></span><span>原作者：<?php echo $reprint->author;?></span><span>本人博客[<a href="<?php echo base_url("");?>">第十人</a>]</span> </span><span>阅读 (<?php echo $reprint->view_count;?>)</span></p>
  ...
  <aside class="right">
    ...
    <ul class="rank">
      <?php foreach ($last_five as $last_five):?>
        <li><a href="<?php echo "index.php/blog/".$last_five->id;?>" title="<?php echo $last_five->title ;?>" target="_blank"><?php echo $last_five->title ;?></a></li>
      <?php endforeach;?>
